...
#define _________________MAINLAYER_L2_________________        LHOME_1, LHOME_2, LHOME_3, LHOME_4, KC_G
...
#define _________________MAINLAYER_R2_________________        KC_H,    KC_J,    KC_K,    KC_L,    KC_SCLN
#define _________________MAINLAYER_R3_________________        KC_N,    RHOME_1, RHOME_2, RHOME_3, RHOME_4
...
#define _________________NAV_L1____________________         _______, _______, _______, _______,  G(KC_GRV)
#define _________________NAV_L2____________________         _______, _______, _______, _______,  KC_GRV 
#define _________________NAV_L3____________________         _______, _______, _______, S(KC_GRV), _______
...
#define _________________NAV_R3____________________         _______, _______, _______, _______, _______
