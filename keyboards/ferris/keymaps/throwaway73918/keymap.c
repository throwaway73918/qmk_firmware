...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [_ALPHA] = LAYOUT_ferris_wrapper(
            _________________MAINLAYER_L1_________________, _________________MAINLAYER_R1_________________,
            _________________MAINLAYER_L2_________________, _________________MAINLAYER_R2_________________,
            _________________MAINLAYER_L3_________________, _________________MAINLAYER_R3_________________,
